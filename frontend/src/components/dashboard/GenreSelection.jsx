// ==================== src/components/dashboard/GenreSelection.jsx ====================
...
function GenreSelection() {
  ...
  const fetchGenresData = async () => {
    ...
    try {
      ...
      const allGenresResponse = await api.get('api/genres');
      setAllGenres(allGenresResponse.data);
      
      // Fetch user's selected genres
      try {
        const userGenresResponse = await api.get('api/genres/user');
        ...
        console.log('No genres selected yet');
        setSelectedGenres([]);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    ...
    try {
      await api.post('api/genres/user', { genreIds: selectedGenres });
