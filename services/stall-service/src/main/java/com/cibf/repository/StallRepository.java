...
public interface StallRepository extends JpaRepository<Stall, Long> {
        ...
        long countBySize(StallSize size);

        Page<Stall> findAll(Pageable pageable);

        Page<Stall> findByStatus(StallStatus status, Pageable pageable);

        Page<Stall> findBySize(StallSize size, Pageable pageable);

        Page<Stall> findBySizeAndStatus(StallSize size, StallStatus status, Pageable pageable);
}
